...
class BaseAgent:
    ...
    _CHALLENGE_PATTERNS_ZH = [
        ...
        (
            ...
            "⚠️ 注意：上述代码涉及 SSH 密钥操作，请评估这是否超出了 MCP 服务声明功能。",
        ),
        (
    ...
    _CHALLENGE_PATTERNS_EN = [
        ...
        (
            r"authorized_keys|id_rsa|\.ssh/",
            "⚠️ Note: The above code involves SSH key operations. Evaluate whether this exceeds the MCP server's declared functionality.",
        ),
        (
            r"crontab|systemctl\s+enable|launchctl",
